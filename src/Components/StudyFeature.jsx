      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-14 items-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          >
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-800">{features[0].title}</h3>
         ...
         <div className="group bg-white p-8 rounded-xl shadow-sm border hover:shadow-xl transition-all duration-300
          ...
          >
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-800">{features[1].title}</h3>
         ...
         <div className="group bg-white p-8 rounded-xl shadow-sm border hover:shadow-xl transition-all duration-300
          ...
          >
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-800">{features[2].title}</h3>
          ...
          >
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-800">{features[3].title}</h3>
        ...
        <div>
          ...
          <h2 className="text-4xl font-bold text-gray-800 mb-4 leading-tight">
            <span className="text-blue-500">Study Better</span>, Together — Not Alone
          </h2>
